...
src = Path("src/baseline/per_code_analysis.py")
src.write_text(
...
def print_report(stats: pd.DataFrame, n_worst: int = 20, n_best: int = 10) -> None:
...
def main() -> None:
    ...
    print_report(stats, n_worst=args.worst, n_best=args.best)
...
print("wrote src/baseline/per_code_analysis.py")
