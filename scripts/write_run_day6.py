...
CONTENT = '''"""Day 6 driver: train + evaluate all rollups, print a comparison table.
...
Path("src/baseline/run_day6.py").write_text(CONTENT)
print("Wrote src/baseline/run_day6.py")
