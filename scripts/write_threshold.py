...
CONTENT = '''"""Threshold sweep over out-of-fold predictions on the dev bucket.
...
Path("src/baseline/threshold.py").write_text(CONTENT)
print("Wrote src/baseline/threshold.py")
